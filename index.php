...
<body>
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP.</p>
				  </div>
			    	<div class="col s6">
	...
	<div class="footer-copyright" style="padding: 0px 0px">
      <div class="container">
        <p align="center" style="color: #999">&copy; RAHMAD HARET RAYHANDA | TEKNIK INDUSTRI | UNIVERSITAS ANDALAS</p>
      </div>
    </div>
    <!-- Footer End -->
